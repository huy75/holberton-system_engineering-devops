...
wintermancer@lapbox ~/reddit_api/project $ python3 100-main.py programming 'react python java javascript scala no_results_for_this_one'
java: 27
javascript: 20
python: 17
react: 17
scala: 4
wintermancer@lapbox ~/reddit_api/project $ python3 100-main.py programming 'JavA java'
java: 54
